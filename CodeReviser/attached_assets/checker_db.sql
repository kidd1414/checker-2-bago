...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 01, 2025 at 06:49 PM
...
(56, 20220169, 99, 0, 'pending', '2025-03-23 17:11:17'),
(57, 20220169, 98, 1, 'pending', '2025-03-23 17:11:49'),
(58, 20220169, 101, 0, 'pending', '2025-03-23 17:13:21'),
(59, 20220169, 100, 0, 'pending', '2025-03-23 17:40:51'),
...
--
ALTER TABLE `quiz_questions`
  MODIFY `question_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=613;
...
--
ALTER TABLE `student_quiz_submission`
  MODIFY `submission_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;
